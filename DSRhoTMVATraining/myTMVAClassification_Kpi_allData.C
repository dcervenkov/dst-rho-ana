...
int myTMVAClassification_Kpi_allData( TString myMethodList = "" )
{
   ...
   TString outfileName( "myTMVA_Kpi.root" );
   ...
   TMVA::Factory *factory = new TMVA::Factory( "TMVAClassification_Kpi", outputFile,
   ...
   dataloader->AddVariable( "mbc", 'F' );
   dataloader->AddVariable( "shcosthb", 'F' );
   dataloader->AddVariable( "shcostht", 'F' );
   dataloader->AddVariable( "k1mm2", 'F' );
   dataloader->AddVariable( "k1et", 'F' );
   dataloader->AddVariable( "k1hoo0", 'F' );
   dataloader->AddVariable( "k1hoo1", 'F' );
   dataloader->AddVariable( "k1hoo2", 'F' );
   dataloader->AddVariable( "k1hoo3", 'F' );
   dataloader->AddVariable( "k1hoo4", 'F' );
   dataloader->AddVariable( "k1hso00", 'F' );
   dataloader->AddVariable( "k1hso01", 'F' );
   dataloader->AddVariable( "k1hso02", 'F' );
   dataloader->AddVariable( "k1hso03", 'F' );
   dataloader->AddVariable( "k1hso04", 'F' );
   dataloader->AddVariable( "k1hso10", 'F' );
   dataloader->AddVariable( "k1hso12", 'F' );
   dataloader->AddVariable( "k1hso14", 'F' );
   dataloader->AddVariable( "k1hso20", 'F' );
   dataloader->AddVariable( "k1hso22", 'F' );
   dataloader->AddVariable( "k1hso24", 'F' );
   ...
   /* TString fnames1 = "./data/D0Kpi/DSRho-mdst_D0Kpi_1M_svd2.root"; */
   /* TString fnameb1 = "./data/D0Kpi/DSRhoSkim_svd2_on_resonance_evtgen-charm_sall.root"; */
