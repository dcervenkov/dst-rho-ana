...
void FitterCPV::Test() {
    DtCPPDF mixing_pdf_a(
        "mixing_pdf_a", "mixing_pdf_a", true, perfect_tagging_, *thetat_, *thetab_, *phit_,
    ...
    DtCPPDF mixing_pdf_ab(
        "mixing_pdf_ab", "mixing_pdf_ab", true, perfect_tagging_, *thetat_, *thetab_, *phit_,
        *ap_, *apa_, *a0_, *ata_, *xpb_, *x0b_, *xtb_, *ypb_, *y0b_, *ytb_,
        *tagwtag_, *dt_, *tau_, *dm_, *expmc_, *expno_, *shcosthb_, *benergy_, *mbc_, *vrntrk_,
        *vrzerr_, *vrchi2_, *vrndf_, *vtntrk_, *vtzerr_, *vtchi2_, *vtndf_, *vtistagl_);

    DtCPPDF mixing_pdf_b(
        "mixing_pdf_b", "mixing_pdf_b", false, perfect_tagging_, *thetat_, *thetab_, *phit_,
        *ap_, *apa_, *a0_, *ata_, *xp_, *x0_, *xt_, *yp_, *y0_, *yt_,
        *tagwtag_, *dt_, *tau_, *dm_, *expmc_, *expno_, *shcosthb_, *benergy_, *mbc_, *vrntrk_,
        *vrzerr_, *vrchi2_, *vrndf_, *vtntrk_, *vtzerr_, *vtchi2_, *vtndf_, *vtistagl_);

    DtCPPDF mixing_pdf_bb(
        "mixing_pdf_bb", "mixing_pdf_bb", false, perfect_tagging_, *thetat_, *thetab_, *phit_,
        *ap_, *apa_, *a0_, *ata_, *xpb_, *x0b_, *xtb_, *ypb_, *y0b_, *ytb_,
        *tagwtag_, *dt_, *tau_, *dm_, *expmc_, *expno_, *shcosthb_, *benergy_, *mbc_, *vrntrk_,
        *vrzerr_, *vrchi2_, *vrndf_, *vtntrk_, *vtzerr_, *vtchi2_, *vtndf_, *vtistagl_);
