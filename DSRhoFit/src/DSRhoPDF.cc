...
DSRhoPDF::DSRhoPDF(const char *name, const char *title,
                   RooAbsReal& _tht,
                   RooAbsReal& _thb,
                   RooAbsReal& _phit,
                   RooAbsReal& _ap,
    ...
    ata("ata","ata",this,_ata)
{
	...
	// computation of normalization; see DSRhoPDF::analyticalIntegral
	ROOT::Math::Functor wf1(this, &DSRhoPDF::f1, 3);
	ROOT::Math::Functor wf2(this, &DSRhoPDF::f2, 3);
	ROOT::Math::Functor wf3(this, &DSRhoPDF::f3, 3);
	ROOT::Math::Functor wf4(this, &DSRhoPDF::f4, 3);
	ROOT::Math::Functor wf5(this, &DSRhoPDF::f5, 3);
	ROOT::Math::Functor wf6(this, &DSRhoPDF::f6, 3);
...
//    Double_t aptr = ap*at*cos(-apa+ata);
    ...
    return value * eff.GetEfficiency(tht, thb, phit);
}
...
Double_t DSRhoPDF::f1(const double * vars) {
