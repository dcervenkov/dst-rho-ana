...
DSRhoPDFTDep::DSRhoPDFTDep(const char *name, const char *title, const char *_type,
                   RooAbsReal& _tht,
                   RooAbsReal& _thb,
                   RooAbsReal& _phit,
                   RooAbsReal& _dt,
...
DSRhoPDFTDep::DSRhoPDFTDep(const DSRhoPDFTDep& other, const char* name) :
...
Double_t DSRhoPDFTDep::evaluate() const {
    Int_t trig_sign = 1;
...
Int_t DSRhoPDFTDep::getAnalyticalIntegral(RooArgSet& allVars, RooArgSet& analVars, const char* /*rangeName*/) const {
...
Double_t DSRhoPDFTDep::analyticalIntegral(Int_t code, const char* rangeName) const {
