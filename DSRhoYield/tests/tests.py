...
test_configs = {
    "yield_fit": ["tests/data",
                  "tests/data",
                  "plots/test"],
}

# Define post-run command to be run after the main command, before evaluating
# results. The main use for this is to extract relevant results from whatever
# files were created by the test.
post_cmd = ["root", "-q", "-b", "extract_result.cxx"]
